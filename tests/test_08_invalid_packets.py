...
add a delay between rounds to avoid hitting the limit.
"""
...
CYCLE_DELAY = 1.0  # seconds between rounds
        ...
        try:
            async with websockets.connect(
                ...
                try:
                    ...
                    # Server may close after version mismatch - that is OK
                    pass
        except websockets.exceptions.InvalidMessage:
            # Rate limited - skip verification this round
            pass
